...
pub struct PaymentIntentTypeSpecificPaymentMethodOptionsClient {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub installments: Option<crate::generated::PaymentFlowsInstallmentOptions>,
...
impl Default for PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
impl Default for PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
impl Default for PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod {
    fn default() -> Self {
        Self::Automatic
    }
}
