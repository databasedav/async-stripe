...
pub struct GetWebhookEndpointsParams {
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, Default, serde::Deserialize, serde::Serialize)]
pub struct GetWebhookEndpointsWebhookEndpointParams {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub expand: Option<Vec<String>>,
}

#[derive(Clone, Debug, serde::Deserialize, serde::Serialize)]
pub struct PostWebhookEndpointsParams {
    /// Events sent to this endpoint will be generated with this Stripe Version instead of your account's default Stripe Version.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub api_version: Option<PostWebhookEndpointsParamsApiVersion>,
    ...
    pub enabled_events: Vec<PostWebhookEndpointsParamsEnabledEvents>,
...
#[derive(Clone, Debug, Default, serde::Deserialize, serde::Serialize)]
pub struct PostWebhookEndpointsWebhookEndpointParams {
    /// An optional description of what the webhook is used for.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    ...
    /// You may specify `['*']` to enable all events, except those that require explicit selection.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub enabled_events: Option<Vec<PostWebhookEndpointsWebhookEndpointParamsEnabledEvents>>,
...
pub enum PostWebhookEndpointsParamsApiVersion {
...
impl PostWebhookEndpointsParamsApiVersion {
...
impl AsRef<str> for PostWebhookEndpointsParamsApiVersion {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PostWebhookEndpointsParamsApiVersion {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}

impl Default for PostWebhookEndpointsParamsApiVersion {
    fn default() -> Self {
        Self::V2011_01_01
    }
}
...
#[derive(Clone, Copy, Debug, serde::Deserialize, Eq, PartialEq, serde::Serialize)]
#[serde(rename_all = "snake_case")]
pub enum PostWebhookEndpointsParamsEnabledEvents {
    #[serde(rename = "*")]
    All,
...
impl PostWebhookEndpointsParamsEnabledEvents {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::All => "*",
...
impl AsRef<str> for PostWebhookEndpointsParamsEnabledEvents {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PostWebhookEndpointsParamsEnabledEvents {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}

impl Default for PostWebhookEndpointsParamsEnabledEvents {
    fn default() -> Self {
        Self::All
    }
}
...
#[derive(Clone, Copy, Debug, serde::Deserialize, Eq, PartialEq, serde::Serialize)]
#[serde(rename_all = "snake_case")]
pub enum PostWebhookEndpointsWebhookEndpointParamsEnabledEvents {
    #[serde(rename = "*")]
    All,
    #[serde(rename = "account.application.authorized")]
    AccountApplicationAuthorized,
...
impl PostWebhookEndpointsWebhookEndpointParamsEnabledEvents {
    pub fn as_str(self) -> &'static str {
        match self {
            Self::All => "*",
            Self::AccountApplicationAuthorized => "account.application.authorized",
...
impl AsRef<str> for PostWebhookEndpointsWebhookEndpointParamsEnabledEvents {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PostWebhookEndpointsWebhookEndpointParamsEnabledEvents {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}

impl Default for PostWebhookEndpointsWebhookEndpointParamsEnabledEvents {
    fn default() -> Self {
        Self::All
    }
}
pub fn get_webhook_endpoints(
    client: &crate::Client,
    params: GetWebhookEndpointsParams,
) -> crate::Response<crate::params::List<crate::generated::WebhookEndpoint>> {
...
) -> crate::Response<crate::generated::WebhookEndpoint> {
    client.get_query(
...
pub fn post_webhook_endpoints(
    client: &crate::Client,
    params: PostWebhookEndpointsParams,
) -> crate::Response<crate::generated::WebhookEndpoint> {
...
pub fn post_webhook_endpoints_webhook_endpoint(
    client: &crate::Client,
    webhook_endpoint: String,
    params: PostWebhookEndpointsWebhookEndpointParams,
) -> crate::Response<crate::generated::WebhookEndpoint> {
    client.post_form(
        &format!("/webhook_endpoints/{webhook_endpoint}", webhook_endpoint = webhook_endpoint),
        params,
...
pub fn delete_webhook_endpoints_webhook_endpoint(
    client: &crate::Client,
    webhook_endpoint: String,
) -> crate::Response<crate::generated::DeletedWebhookEndpoint> {
