...
pub struct IssuingCardAuthorizationControls {
    ...
    pub spending_limits: Option<Vec<crate::generated::IssuingCardSpendingLimit>>,
...
impl AsRef<str> for IssuingCardAuthorizationControlsAllowedCategories {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for IssuingCardAuthorizationControlsAllowedCategories {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}

impl Default for IssuingCardAuthorizationControlsAllowedCategories {
    fn default() -> Self {
...
impl AsRef<str> for IssuingCardAuthorizationControlsBlockedCategories {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for IssuingCardAuthorizationControlsBlockedCategories {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}

impl Default for IssuingCardAuthorizationControlsBlockedCategories {
    fn default() -> Self {
        Self::AcRefrigerationRepair
    }
}
