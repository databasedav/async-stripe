...
pub struct PaymentIntentPaymentMethodOptionsAcssDebit {
    ...
    pub mandate_options:
        Option<crate::generated::PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit>,
...
impl Default for PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
impl Default for PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod {
    fn default() -> Self {
        Self::Automatic
    }
}
