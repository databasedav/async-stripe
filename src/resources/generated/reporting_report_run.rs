...
pub struct ReportingReportRun {
    ...
    pub parameters: crate::generated::FinancialReportingFinanceReportRunRunParameters,
    ...
    ///  `status=succeeded`).
    pub result: Option<crate::generated::File>,
...
pub struct GetReportingReportRunsReportRunParams {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub expand: Option<Vec<String>>,
}

#[derive(Clone, Debug, serde::Deserialize, serde::Serialize)]
pub struct PostReportingReportRunsParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub parameters: Option<PostReportingReportRunsParamsParameters>,
...
#[derive(Clone, Debug, Default, serde::Deserialize, serde::Serialize)]
pub struct GetReportingReportRunsParams {
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// Different Report Types have different required and optional parameters, listed in the [API Access to Reports](https://stripe.com/docs/reporting/statements/api) documentation.
#[derive(Clone, Debug, Default, serde::Deserialize, serde::Serialize)]
pub struct PostReportingReportRunsParamsParameters {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reporting_category: Option<PostReportingReportRunsParamsParametersReportingCategory>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub timezone: Option<PostReportingReportRunsParamsParametersTimezone>,
}

#[derive(Clone, Copy, Debug, serde::Deserialize, Eq, PartialEq, serde::Serialize)]
#[serde(rename_all = "snake_case")]
pub enum PostReportingReportRunsParamsParametersReportingCategory {
    Advance,
    AdvanceFunding,
...
impl PostReportingReportRunsParamsParametersReportingCategory {
...
impl AsRef<str> for PostReportingReportRunsParamsParametersReportingCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PostReportingReportRunsParamsParametersReportingCategory {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}

impl Default for PostReportingReportRunsParamsParametersReportingCategory {
    fn default() -> Self {
        Self::Advance
    }
}
...
#[derive(Clone, Copy, Debug, serde::Deserialize, Eq, PartialEq, serde::Serialize)]
#[serde(rename_all = "snake_case")]
pub enum PostReportingReportRunsParamsParametersTimezone {
...
impl PostReportingReportRunsParamsParametersTimezone {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for PostReportingReportRunsParamsParametersTimezone {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PostReportingReportRunsParamsParametersTimezone {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}

impl Default for PostReportingReportRunsParamsParametersTimezone {
    fn default() -> Self {
        Self::AfricaAbidjan
    }
}
...
) -> crate::Response<crate::generated::ReportingReportRun> {
    client
...
pub fn post_reporting_report_runs(
    client: &crate::Client,
    params: PostReportingReportRunsParams,
) -> crate::Response<crate::generated::ReportingReportRun> {
...
) -> crate::Response<crate::params::List<crate::generated::ReportingReportRun>> {
